...
function CharacterEditTemplate_Mobile({
  character,
  setUpdateCharacter,
  saveCharacter,
  undoCharacter,
  ...
  return (
    <div className="character-sheetpage">
      <h2>
        <input
          type="text"
          name="name"
      ...
      <div className="character-sheetpage_characteristics">
        {Object.entries(character.characteristics).map((c) => (
          <div
...
export default CharacterEditTemplate_Mobile;
